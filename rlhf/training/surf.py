...
def semi_supervised_labeling(preference_predictor, sampler, args, tda_active):
    ...
    ssl_preference_buffer = PreferenceBuffer(args.pref_batch_size * 5)
    ...
    labeled_batch_size = args.pref_batch_size * 4
    ...
    unlabeled_trajectories_list = sampler.uniform_trajectory_pair_batch(
        args.traj_length, args.feedback_frequency, labeled_batch_size, args.synthetic_feedback
    )
...
def surf(preference_optimizer, sampler, args, preference_buffer):
    """
    ...
    if args.ssl and args.tda_active:  # Semi-supervised labeling with TDA (Trajectory Data Augmentation)
        ...
        entropy_loss, ratio = preference_optimizer.train_reward_models_surf(
            augmented_pb, ssl_preference_buffer, args.pref_batch_size, loss_weight_ssl=args.loss_weight_ssl
        )
        ...
        entropy_loss, ratio = preference_optimizer.train_reward_models_surf(
            unchanged_preference_buffer, ssl_preference_buffer, args.pref_batch_size,
