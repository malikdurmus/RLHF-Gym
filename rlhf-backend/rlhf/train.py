...
import time
import numpy as np
from preference_predictor import train_reward_model


def train(envs, rb, actor, qf1, qf2, rew_nw, qf1_target, qf2_target, q_optimizer, actor_optimizer, args, writer, device, sampler, pb):
